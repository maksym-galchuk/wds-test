...
<p class="hf-premium">
    <?php echo sprintf( __('Export submissions to CSV, mark submissions as seen or unseen, and manage data columns with <a href="%s">HTML Forms Premium</a>', 'html-forms' ), 'https://htmlformsplugin.com/pricing/#utm_source=wp-plugin&amp;utm_medium=html-forms&amp;utm_campaign=submissions-tab' ); ?>.
</p>
<?php endif; ?>
