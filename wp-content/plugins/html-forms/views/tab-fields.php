<div class="hf-small-margin">
    ...
    <p class="hf-premium">
        <?php echo sprintf( __('Add a File Upload field with <a href="%s">HTML Forms Premium</a>', 'html-forms' ), 'https://htmlformsplugin.com/pricing/#utm_source=wp-plugin&amp;utm_medium=html-forms&amp;utm_campaign=fields-tab' ); ?>.
    </p>
    <?php endif; ?>
</div>
...
<div class="hf-small-margin">
	<div class="hf-row">
		<div class="hf-col" style="min-width: 600px;">
			<h4 style="margin-bottom: 8px;"><label for="hf-form-editor"><?php _e('Form Code', 'html-forms'); ?> <span class="dashicons dashicons-editor-help" style="visibility: hidden;"></span></label></h4>
		...
		<div class="hf-col" style="min-width: 400px;">
			<h4 style="margin-bottom: 8px;"><label><?php _e('Form Preview', 'html-forms'); ?></label></h4>
